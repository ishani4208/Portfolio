  ...
  return (
    <section className="text-white py-20" id="about">
      <div className="md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16">
        <Image src="/images/WhatsApp Image 2024-07-22 at 23.06.35_8ce0201c.jpg" width={500} height={500} />
        <div className="mt-4 md:mt-0 text-left flex flex-col h-full">
          <h2 className="text-4xl font-bold text-white mb-4">About Me</h2>
          <p className="text-base lg:text-lg">
            I am a web developer with a passion for creating
            interactive and responsive web applications. I am beginner though I have experience
            ...
            I always look forward to work with others to create amazing applications.
          </p>
